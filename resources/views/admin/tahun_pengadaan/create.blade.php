@extends('layouts.app')
@section('title', 'Tambah Tahun Pengadaan')
...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-800 tracking-tight">Tambah Tahun Pengadaan</h2>
</div>

<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 max-w-2xl">
    <form action="{{ route('tahun-pengadaan.store') }}" method="POST" class="space-y-6">
        @csrf
        
        <div>
            <label for="tahun" class="block text-sm font-semibold text-gray-700 mb-2">Tahun <span class="text-red-500">*</span></label>
            <input type="number" name="tahun" id="tahun" required autofocus
