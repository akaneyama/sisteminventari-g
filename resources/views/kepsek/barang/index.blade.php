        ...
        <table class="min-w-full divide-y divide-gray-100">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Supplier/Sumber</th>
                    <th class="px-6 py-4 text-right text-xs font-bold text-gray-500 uppercase tracking-wider w-24">Label</th>
                </tr>
            </thead>
            <tbody class="bg-white divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50/50 transition-colors">
                    <td class="px-4 py-4">
                        <input type="checkbox" value="{{ $item->id_barang }}" class="item-check rounded text-blue-600 cursor-pointer w-4 h-4" onchange="updateCount()">
                    </td>
                        ...
                        <div class="flex items-center">
                            @if($item->foto_barang)
                                <div class="relative group cursor-pointer mr-3 flex-shrink-0" onclick="openImageModal('{{ asset('storage/' . $item->foto_barang) }}')" title="Lihat Foto">
                                    <img class="h-10 w-10 rounded-lg object-cover border border-gray-200" src="{{ asset('storage/' . $item->foto_barang) }}" alt="Foto">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">{{ $item->jumlah_barang }} Unit</td>
                ...
                <tr>
                    <td colspan="8" class="px-6 py-12 text-center text-gray-500">
                        ...
                        <p class="text-base font-medium text-gray-600">Tidak ada data barang yang sesuai.</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
